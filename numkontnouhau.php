...
<?php
$query = "SELECT nouhau.id, nouhau.nouhau, nouhau.inventory, nouhau.dateinventory, nouhau.registry, nouhau.cost, nouhau.idgk, nouhau.status, gk.number, gk.dategk, gk.cipher FROM nouhau, gk WHERE nouhau.idgk = gk.id AND gk.number = $numk";
...
?>
 <style type="text/css">
  ...
  <?php
    ...
    echo "<h2>Ноу-Хау по контракту № $numkk</h2></br>";
    echo "<table>";
    echo "<tr>";
    echo "<th>Ноу-Хау</th>";
